...
<div class="mksddn-form-tabs">
    ...
    <div id="mksddn-tab-sheets" class="mksddn-form-tab-content">
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><label for="sheets_sheet_name"><?php echo esc_html__( 'Tab Name', 'mksddn-forms-handler' ); ?></label></th>
                <td>
    ...
    <div id="mksddn-tab-advanced" class="mksddn-form-tab-content">
        <table class="form-table">
            ...
            <tr>
                <th scope="row">
                    <label>
                        <input type="checkbox" name="require_turnstile" id="require_turnstile" value="1" <?php checked($require_turnstile, '1'); ?> />
                        <?php echo esc_html__( 'Require Cloudflare Turnstile', 'mksddn-forms-handler' ); ?>
                    </label>
                </th>
                <td>
